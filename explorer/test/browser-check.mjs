...
assert.equal(await page.locator('.header-citation').count(),3);
...
assert.match(await page.locator('.header-citation').nth(1).innerText(),/Submitted to bioRxiv; screening in progress/);
assert.match(await page.locator('.header-citation').nth(2).innerText(),/Zenodo\. doi:10\.5281\/zenodo\.22849800/);
assert.equal(await page.locator('.header-citation').nth(2).locator('a').getAttribute('href'),'https://doi.org/10.5281/zenodo.22849800');
